...
import rag from './images/aftermath-one-shot-rag.png'
...
const Home = (props) => {
  return (
    <div>
      ...
      <img className='news-img' src={rag} />
      ...
      <p className='news-p'>Sunday comes. We roll out to MC. Just for good measure, we kill Domo again (well actually we had to because he somehow came back to life 😕)... no problem... one-shot. We are prepared. Rag is not. ONE-SHOT!</p>
