...
function App() {
  ...
  const transitions = useTransition(location, location => location.pathname, {
    from: { opacity: 0, WebkitTransform: 'translate3d(0,0,0)', WebkitoverflowScrolling: 'touch' },
    enter: { opacity: 1, WebkitTransform: 'translate3d(0,0,0)', WebkitoverflowScrolling: 'touch' },
    leave: { opacity: 1, WebkitTransform: 'translate3d(0,0,0)', WebkitOverflowScrolling: 'touch' }
  });
  // return JSX
  return (
